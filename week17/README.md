Bootcamp day 6 SWAPI Tree Rendering (Movies > Starships > Pilots)

*Topics practiced*

- Asynchronous flow with  and 

- Dynamic DOM rendering with nested components

- Star Wars API data structure
